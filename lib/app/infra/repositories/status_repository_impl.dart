...
class StatusRepositoryImpl implements StatusRepository {
  ...
  @override
  Future<Either<StatusExeption, bool>> deleteStatus(
      ParamsDeleteStatus params) async {
    try {
      final status = await datasource.deleteStatus(params);
      return Right(status);
    } on StatusExeption catch (e) {
      return Left(e);
    } on Exception {
  ...
  Future<Either<StatusExeption, bool>> changeStatusOrder(
    ...
    try {
      final status = await datasource.changeStatusOrder(params);
      return Right(status);
    } on StatusExeption catch (e) {
      return Left(e);
    } on Exception {
